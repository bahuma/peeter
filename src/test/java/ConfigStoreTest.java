...
public class ConfigStoreTest {
	...
	public void testGet() throws Exception {
		...
		Assert.assertTrue("\"testValue\" should be \"123456789\"", conStore
				.get("testValue").equals("123456789"));
	}
	...
	public void testUnset() throws Exception {
		...
		Assert.assertNull("\"testValue\" should not be set",
				conStore.get("testValue"));
	}
}