...
public class StringProviderTest {
	...
	public void testGet() throws Exception {
		...
		Assert.assertTrue("String \"test.first\" should be \"Erster Test\"",
				prov.get("test.first").equals("Erster Test"));
		Assert.assertTrue("String \"test.second\" should be \"Zweiter Test\"",
				prov.get("test.second").equals("Zweiter Test"));
		...
		Assert.assertTrue("String \"test.first\" should now be \"First Test\"",
				prov.get("test.first").equals("First Test"));
		Assert.assertTrue(
				"String \"test.second\" should now be \"Second Test\"", prov
						.get("test.second").equals("Second Test"));
	}
}